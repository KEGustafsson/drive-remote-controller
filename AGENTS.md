...
cd sk-plugin && npm test                    # 276 cases
cd sk-plugin && npm run build               # -> public/
cd android && ./gradlew :core:test          # pure Kotlin core, 176 cases
cd android && ./gradlew :app:testDebugUnitTest  # layout + fail-safe UI, 73 cases (needs SDK)
